  ...
  return (
    <div>
      ...
      <p className="App-intro">
        The cannaledger is an open, distributed blockchain for recording actions
        undertaken by workers in the cannabis industry.
      </p>
      <h1>So what does any of this mean?</h1>
      <p>
        Typically, digital data is hosted on a company's server, this means that
        all the data owned by a company exclusively belongs to them. The
      ...
      <p className="App-intro">
        ...
        Incorporation offers workplace interfaces available for $10 per employee
        per month.
      </p>
