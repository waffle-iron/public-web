        ...
        <BrowserRouter>
          <div className="App">
            ...
            <p>
              ...
              means that all the data owned by a company exclusively belongs to
              them. The blockchain is different in that instead of data being
              hosted in one spot, it is hosted in as many places as possible,
              with the blockchain itself taking care of data duplication and
              redudancy.
            </p>
            <p>
              While all the data is recorded publically, each data point can be
              protected in terms of who gets to access it by proven
              cryptographic mathematics.
            </p>
            <p className="App-intro">
              It is built on top of Hyperledger Sawtooth, and uses state of the
              art consensus algorithms to ensure data integrity and speed as
              actions get recorded to the ledger.
            </p>
            <h1>Interfacing with Cannaledger</h1>
            <p className="App-intro">
              If you're technically inclined, we encourage you to develop your
              own interfaces to the blockchain itself. Otherwise the Cannaledger
